from telegram.ext import Updater, CommandHandler, MessageHandler, Filters  # импорт нужных компонентов
import logging

PROXY = { 'proxy_url' : 'socks5://t1.learn.python.ru:1080',
     'urllib3_proxy_kwargs': {'username' : 'learn', 
     'password' : 'python'}} # настройка прокси
...
def main ():
    mybot = Updater ("818981926:AAFI-on28v8wHV5pISiRzs2Uztq9re__4Os", request_kwargs = PROXY)
